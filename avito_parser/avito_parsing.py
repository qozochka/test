    ...
    def get_user_city(self):
        ...
        try:
            ...
            user_city = self.driver.find_element(By.CSS_SELECTOR,
                                                 "input.styles-module-searchInput"
                                                 "-DS602[placeholder='Город или "
                                                 "регион']")
            ...
            city_button = self.driver.find_element(By.XPATH,
                                                   f"//button["
                                                   f"@type='button']//strong["
                                                   f"contains(text(), "
                                                   f"{self.city})][not("
                                                   f"preceding-sibling::text())]["
                                                   f"not(following-sibling::text("
                                                   f"))]")
    ...
    def get_filters(self):
        ...
        try:
            ...
            rent_button = self.driver.find_element(By.XPATH,
                                                   "//span[@data-category-id='24' and contains(text(), 'Снять долгосрочно')]")
            ...
            rooms_option = WebDriverWait(self.driver, 15).until(
            ...
            if self.without_comission:
                commission = WebDriverWait(self.driver, 17).until(
